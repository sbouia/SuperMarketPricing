...
class PricingTest {
    ...
    void should_calculate_total_amount_of_bought_articles() {
        //Given
        ArticleWithoutWeight article1 = ArticleWithoutWeight
                .builder()
                    .name("article1")
                    .price(100)
                .build();
        ...
        ArticleWithQuantity articleWithQuantity1 = ArticleWithQuantity
                .builder()
                    .article(article1)
                    .quantity(3)
                .build();

        ArticleWithQuantity articleWithQuantity2 = ArticleWithQuantity
                .builder()
                    .article(article2)
                    .quantity(2)
                .build();

        Set<ArticleWithQuantity> articleWithQuantities =
                new HashSet<>(Arrays.asList(articleWithQuantity1, articleWithQuantity2));
        //When
    ...
    void should_calculate_total_amount_of_bought_weighted_articles_in_ounces() {
        //Given
        ArticleWithWeight article = ArticleWithWeight
                .builder().name("article1")
                    .price(100)
                    .unity(Unity.POUND)
                .build();
        ...
        ArticleWithQuantity articleWithQuantity = ArticleWithQuantity
                .builder()
                    .article(article)
                    .quantity(Unity.OUNCE.convertToPound(quantityInOunce))
                .build();

        Set<ArticleWithQuantity> articleWithQuantities =
                new HashSet<>(Collections.singletonList(articleWithQuantity));
        //When
        double result = pricingService.calculateTotal(articleWithQuantities);
        //Then
    ...
    void should_return_total_for_articles_with_promos() {
        ...
        ArticleWithoutWeight article1 = ArticleWithoutWeight
                .builder()
                    .name("article1")
                    .price(100)
                    .promos(new HashSet<>(Arrays.asList(promoThreeForDollar, promoBuyTwoGetOneFree)))
                .build();
